...
class StoreTreatmentRequest extends FormRequest
{
    ...
    {
        return [
            'name'          => ['required', 'string', 'max:50', Rule::unique('treatments', 'name')->whereNull('deleted_at')],
            'code'          => ['required', 'string', 'max:30', Rule::unique('treatments', 'code')->whereNull('deleted_at')],
