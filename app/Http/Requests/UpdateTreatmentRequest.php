...
class UpdateTreatmentRequest extends FormRequest
{
    ...
    {
        return [
            'name'          => ['required', 'string', 'max:50', Rule::unique('treatments', 'name')->ignoreModel($this->route('treatment'))->whereNull('deleted_at')],
            'code'          => ['required', 'string', 'max:30', Rule::unique('treatments', 'code')->ignoreModel($this->route('treatment'))->whereNull('deleted_at')],
