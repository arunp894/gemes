...
class UpdateShapeRequest extends FormRequest
{
    ...
    {
        return [
            'name'          => ['required', 'string', 'max:50', Rule::unique('shapes', 'name')->ignoreModel($this->route('shape'))->whereNull('deleted_at')],
            'code'          => ['required', 'string', 'max:30', Rule::unique('shapes', 'code')->ignoreModel($this->route('shape'))->whereNull('deleted_at')],
