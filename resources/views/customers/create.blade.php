...
<div class="container-fluid customers-page customers-form-page">
...
@push('styles')
<style>
    /* Compact spacing for the Add/Edit Customer form — scoped to this page only */
    .customers-form-page { padding-top: 20px; padding-bottom: 20px; }
    .customers-form-page .page-title-head {
    ...
    .customers-form-page .page-main-title {
        font-size: 1.375rem;
        font-weight: 700;
        position: relative;
        padding-left: 12px;
    }
    .customers-form-page .page-main-title::before {
        content: '';
        position: absolute;
    ...
    .customers-form-page .breadcrumb { font-size: 0.75rem; }
    .customers-form-page .card { border-radius: 10px; box-shadow: none; border: 1px solid #e2e8f0; margin-bottom: 16px; }
    .customers-form-page .card-header { padding: 12px 16px; }
    .customers-form-page .card-title { font-size: 1rem; font-weight: 700; }
    .customers-form-page .card-body { padding: 16px; }
    .customers-form-page .header-title { font-size: 1rem; font-weight: 700; }
    .customers-form-page .mb-3, .customers-form-page .mb-4 { margin-bottom: 12px !important; }
    .customers-form-page .form-label { margin-bottom: 4px; font-size: 0.8125rem; font-weight: 600; }
    .customers-form-page .form-control, .customers-form-page .form-select { padding: 0.4rem 0.65rem; font-size: 0.8125rem; }
    .customers-form-page small.text-muted { display: inline-block; margin-top: 3px; font-size: 0.75rem; }
    .customers-form-page .d-flex.justify-content-end.gap-2,
    .customers-form-page .d-flex.gap-2.justify-content-end { margin-top: 4px !important; }
</style>
@endpush
