...
@section('title', 'Add Country of Origin')
...
<div class="container-fluid country-origins-page country-origins-form-page">
    ...
    <div class="page-title-head d-flex align-items-center">
        <div class="flex-grow-1">
            <h4 class="page-main-title m-0">Add Country of Origin</h4>
        </div>
        <div class="text-end">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Unique name (e.g. Mozambique, Brazil, Sri Lanka).</small>
                    </div>
        ...
        new Vue({
            ...
            methods: {
                ...
                async submitForm() {
                    ...
                    try {
                        const res = await fetch('{{ route('country-origins.store') }}', {
                            method: 'POST',
                            headers: {
