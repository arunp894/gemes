...
<div class="container-fluid shapes-page shapes-form-page" id="shapeFormApp">
    ...
    <div class="page-title-head d-flex align-items-center">
        <div class="flex-grow-1">
            <h4 class="page-main-title m-0">
                <i class="ti ti-diamond me-2"></i>New Shape
            </h4>
        </div>
        <div class="text-end">
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title mb-2">Shape Details</h4>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control"
                                ...
                                placeholder="e.g. Round, Oval, Pear, Cushion"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="text-muted small mb-0 ps-3">
                        ...
                        <li>Inactive shapes are hidden from selection lists but not deleted.</li>
                    </ul>
                </div>
            </div>
        </div>
...
<style>
    ...
    .shapes-form-page ul.ps-3 { padding-left: 1.1rem !important; }
    .shapes-form-page ul.ps-3 li { margin-bottom: 6px; }
    .shapes-form-page ul.ps-3 li:last-child { margin-bottom: 0; }
</style>
@endpush
    ...
    new Vue({
        ...
        methods: {
            ...
            async submit() {
                ...
                try {
                    const res = await fetch('{{ route('shapes.store') }}', {
                        method: 'POST',
                        headers: {
