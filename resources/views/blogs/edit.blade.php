                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <div id="content-editor" class="blogs-editor" :class="{ 'is-invalid': errors.content }"></div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('blogs.show', $blog) }}" class="btn btn-secondary">Cancel</a>
                    </div>
                </div>
            </div>
...
<style>
    ...
    .blogs-form-page .blogs-editor .ql-container { min-height: 280px; font-size: 0.875rem; border-bottom-left-radius: 4px; border-bottom-right-radius: 4px; }
    .blogs-form-page .blogs-editor .ql-toolbar { border-top-left-radius: 4px; border-top-right-radius: 4px; }
    .blogs-form-page .blogs-editor.is-invalid .ql-toolbar,
    .blogs-form-page .blogs-editor.is-invalid .ql-container { border-color: #dc3545; }
            ...
            methods: {
                pickEditorImage() {
                    ...
                    input.onchange = async () => {
                        ...
                        try {
                            const res = await fetch('{{ route('blogs.upload-image') }}', {
                                method: 'POST',
