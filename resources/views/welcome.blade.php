                        ...
                        <div class="card-header justify-content-between">
                            ...
                            <div class="dropdown ms-auto">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="#"> <i class="ti ti-download me-2"></i> Download
                                            Report </a>
                                    </li>
                                    <li>
                        ...
                        <table class="table table-custom table-centered table-hover w-100 mb-0">
                            <tbody class="text-nowrap">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-warning-subtle text-warning px-2 py-1 rounded-pill fs-12">
                                            Low Stock </span>
                                    </td>
                                </tr>
                        ...
                        <div class="card-header justify-content-between">
                            ...
                            <div class="dropdown ms-auto">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="#"> <i class="ti ti-download me-2"></i> Export
                                            Revenue Data </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="#"> <i class="ti ti-filter-2 me-2"></i> Filter By
                                            Region </a>
                                    </li>
                                    <li>
                                        <hr class="dropdown-divider" />
                    ...
                    <div class="card card-h-100">
                        <div class="card-header justify-content-between">
                            ...
                            <div class="dropdown ms-auto">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <a class="dropdown-item" href="#"> <i class="ti ti-activity me-2"></i> View
                                            Activity Log </a>
                                    </li>
                                    <li>
