            ...
            <div class="card">
                <div class="card-header border-light justify-content-between">
                    ...
                    <div class="d-flex align-items-center gap-1 flex-wrap">
                        ...
                        <a href="{{ route('sales.create') }}" class="btn btn-primary ms-1">
...
<style>
    ...
    #salesTable_wrapper .dataTables_length, #salesTable_wrapper .dataTables_filter { display: none !important; }
...
<script>
    $(function () {
        ...
        $('#salesTable tbody').on('click', '.js-delete-sale', function () {
            ...
            if (!confirm('Delete sale ' + number + '? (Soft delete.)')) return;
            $.ajax({
                url, type: 'DELETE',
                headers: { 'X-CSRF-TOKEN': csrfToken, 'Accept': 'application/json' },
                success: function (res) { if (res.ok) dt.ajax.reload(null, false); else alert(res.message); },
