...
<div class="container-fluid stones-page stones-form-page">
    ...
    <div id="categoryCreateApp" class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title mb-2">Stone Details</h4>
...
<style>
    ...
    .stones-form-page ul.ps-3 { padding-left: 1.1rem !important; }
    .stones-form-page ul.ps-3 li { margin-bottom: 6px; }
    .stones-form-page ul.ps-3 li:last-child { margin-bottom: 0; }
</style>
@endpush
