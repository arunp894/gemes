...
<div class="container-fluid">
    ...
    <div class="page-title-head d-flex align-items-center">
        <div class="flex-grow-1">
            <h4 class="page-main-title m-0">Add Banner</h4>
        </div>
        <div class="text-end">
                    ...
                    <div class="row g-3">
                        <div class="col-md-8">
                            ...
                            <input type="text" class="form-control"
                                ...
                                placeholder="e.g. Summer Gemstone Sale">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <small class="text-muted">Leave blank to go live immediately.</small>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <small class="text-muted">Leave blank to keep live indefinitely.</small>
                        </div>
                    </div>
                </div>
            </div>
        ...
        new Vue({
            ...
            methods: {
                ...
                async submitForm() {
                    ...
                    try {
                        const res = await fetch('{{ route('banners.store') }}', {
                            method: 'POST',
                            headers: {
