...
@section('title', 'New Packing')

@section('content')
<div class="container-fluid" id="packingFormApp">

    <div class="page-title-head d-flex align-items-center">
        <div class="flex-grow-1"><h4 class="page-main-title m-0">New Packing</h4></div>
        <div class="text-end">
    ...
    <div class="card">
        ...
        <div class="card-body row g-3">
            ...
            <div class="col-md-5">
                ...
                <small class="text-muted">Raw stock must already be on hand at this location.</small>
            </div>
            <div class="col-md-4">
                        ...
                        <tr v-for="(s, i) in form.sources" :key="i">
                            ...
                            <td class="text-center">
                                <div class="form-check form-switch d-flex justify-content-center mb-0">
                                    <input class="form-check-input" type="checkbox" role="switch" v-model="s.website_enabled" :title="'Show on website'">
                                </div>
                            </td>
                            <td class="text-end">
    ...
    <div class="card">
        <div class="card-footer text-end d-flex justify-content-end gap-2">
            <a href="{{ route('packings.index') }}" class="btn btn-light">Cancel</a>
            <button type="button" class="btn btn-soft-primary" :disabled="submitting" @click="submit('draft')">
                Save as Draft
            </button>
            <button type="button" class="btn btn-primary" :disabled="submitting" @click="submit('posted')">
...
new Vue({
    ...
    methods: {
        ...
        submit(status) {
            ...
            const payload = Object.assign({}, this.form, { status });
            ...
            .catch(() => { this.topError = 'A network error occurred. Please try again.'; })
